...
public class AddRoomForm implements Initializable {
    ...
    private boolean addRoom() throws SQLException, ClassNotFoundException,NullPointerException {
        boolean isAdded = roomBO.addRoom(new RoomDTO(txtRoomID.getText(), txtDescription.getText(), Double.parseDouble(txtPrice.getText()),
                    "Available", "Exists", "lk/diyaulpatha/asserts/rooms/" + txtImage.getText()));
        return isAdded;
    }
