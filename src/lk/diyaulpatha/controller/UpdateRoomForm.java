...
public class UpdateRoomForm implements Initializable {
    ...
    private boolean updateRoom() throws SQLException, ClassNotFoundException,NullPointerException {
        boolean isUpdated = roomBO.updateRoom(new RoomDTO(txtSearchField.getText(),txtDescription.getText(),
                Double.parseDouble(txtPrice.getText()),available,"Exists","lk/diyaulpatha/asserts/rooms/" + txtImage.getText()));
        return isUpdated;
    }
